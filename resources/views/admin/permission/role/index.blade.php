            ...
            <div class="box col-xs-11">
                <div class="box-header" style="padding-left: 0;">
                    ...
                    <div  style="text-align: right">
                        <a href="{{url('role/edit')}}" class="btn btn-info"><i class="fa fa-plus"></i> 添加角色</a>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('role/edit?id='.$item->id)}}" class="btn btn-default btn-sm">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>

                                    <a href="javascript:void (0);"  class="btn btn-danger btn-sm submitDelete"
                                       data-url="{{url('role/delete')}}" data-id="{{$item->id}}">
