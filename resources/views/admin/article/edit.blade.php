                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4" style="padding-left: 0;">
                            <input type="text" name="title" value="{{isset($data) ? $data->name : ''}}" class="form-control" id="input_name"
                                   placeholder="请填写文章标题">
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="">
                        ...
                        <textarea  id="editor" name="contents" style="width:75%;height:400px;display: inline-block" title="文章内容">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            <label><input type="radio" name="is_comment" value="0" checked="checked"> 允 许</label>
                            <label style="margin-left:25px;"><input type="radio" name="is_comment" value="1"> 禁 止</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            <label><input type="radio" name="is_recommend" value="1"> 推 荐</label>
                            <label style="margin-left:25px;"><input type="radio" name="is_recommend" value="0" checked="checked"> 不推荐</label>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="input_path" class="col-sm-3 control-label" >关联文章的URL :</label>
                        <input type="text" name="path" class="form-control" style="width: 45%;" id="input_path" placeholder="http://www....">
                    </div>
